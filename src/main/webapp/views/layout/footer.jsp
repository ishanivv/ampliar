...
<script src="../resources/core/js/jquery-2.0.0.min.js"></script> <!-- Jquery Library Call -->
<script src="../resources/core/vendor/prettyphoto/js/prettyphoto.js"></script> <!-- PrettyPhoto Plugin -->
<script src="../resources/core/js/ui-plugins.js"></script> <!-- UI Plugins -->
<script src="../resources/core/js/helper-plugins.js"></script> <!-- Helper Plugins -->
<script src="../resources/core/vendor/owl-carousel/js/owl.carousel.min.js"></script> <!-- Owl Carousel -->
<script src="../resources/core/vendor/password-checker.js"></script> <!-- Password Checker -->
<script src="../resources/core/js/bootstrap.js"></script> <!-- UI -->
<script src="../resources/core/js/init.js"></script> <!-- All Scripts -->
<script src="../resources/core/vendor/flexslider/js/jquery.flexslider.js"></script> <!-- FlexSlider -->
